...
public class GraphGenerator {
    ...
    /**
     * Returns a random simple AdjacencyListAdjacencyListGraph on {@code V} vertices, with an 
     * edge between any two vertices with probability {@code p}. This is sometimes
     * referred to as the Erdos-Renyi random AdjacencyListAdjacencyListGraph model.
     * @param V the number of vertices
     * @param p the probability of choosing an edge
     * @return a random simple AdjacencyListAdjacencyListGraph on {@code V} vertices, with an edge between
    ...
    /**
     * Returns the complete AdjacencyListAdjacencyListGraph on {@code V} vertices.
     * @param V the number of vertices
    ...
    /**
     * Unit tests the {@code AdjacencyListGraphGenerator} library.
     *
